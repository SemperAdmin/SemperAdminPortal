      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <section className="space-y-2">
          ...
          <ul className="space-y-1 pl-0 text-zinc-700 dark:text-zinc-300">
            <li><a href="https://usmc.sharepoint-mil.us.mcas-gov.us/sites/DCMRA_mra_SemperAdmin/SitePages/TemplateToolBox.aspx" target="_blank" rel="noopener noreferrer" className="text-[var(--sa-red)] hover:underline">TemplateToolBox</a></li>
