    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Imminent Danger Pay", slug: "imminent-danger-pay", desc: "$225/month for service in designated danger areas" },
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Legacy High-3 Traditional Plan", slug: "legacy-high-3", desc: "Pre-2018 retirement at 2.5% per year of service" },
              ...
              <ul className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                {g.items.map((i) => (
                  <li key={i.title} className="rounded-md border border-black/5 bg-white p-3 text-sm shadow-sm transition hover:bg-[var(--sa-cream)]/60 dark:border-white/15 dark:bg-black/60 dark:hover:bg-white/10">
                    {i.slug ? (
                      <Link href={`/roles/${safeRole}/${key}/${i.slug}`} className="block">
