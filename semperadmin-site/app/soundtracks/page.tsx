        ...
        <div className="grid items-center gap-8 md:grid-cols-2">
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              <a href={channelUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center rounded-full bg-[var(--sa-navy)] px-6 py-3 text-[var(--sa-cream)] shadow-sm transition hover:bg-[#0a1623]">Visit YouTube Channel</a>
            </div>
          </div>
