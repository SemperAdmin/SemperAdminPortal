    ...
    <div className="grid gap-6 lg:grid-cols-3">
      <div className="lg:col-span-2 space-y-6">
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => setTab("authorization")} className={`rounded-md px-3 py-2 text-sm ${tab === "authorization" ? "bg-[var(--sa-navy)] text-[var(--sa-cream)]" : "bg-[var(--sa-cream)]/60 text-[var(--sa-navy)] dark:bg-white/10 dark:text-[var(--sa-cream)]"}`}>Authorization</button>
        ...
        {tab === "troubleshooter" && (
          <section className="rounded-xl border border-black/5 bg-white p-6 shadow-sm dark:border-white/15 dark:bg-black/40">
            ...
            <div className="mt-6 rounded-2xl border border-red-200 bg-red-50 p-6 text-center">
              ...
              <a href="https://www.travel.dod.mil/Allowances/Overseas-Housing-Allowance/OHA-Rate-Lookup/" target="_blank" rel="noopener noreferrer" className="mt-4 inline-flex items-center gap-2 rounded-xl bg-[var(--sa-red)] px-6 py-3 font-bold text-white transition hover:bg-[#b91c1c]">
