    ...
    <div className="grid gap-6 lg:grid-cols-3">
      <div className="lg:col-span-2 space-y-6">
        <div className="flex items-center gap-2">
          <button onClick={() => setActiveTab("dashboard")} className={`rounded-md px-3 py-2 text-sm ${activeTab === "dashboard" ? "bg-[var(--sa-navy)] text-[var(--sa-cream)]" : "bg-[var(--sa-cream)]/60 text-[var(--sa-navy)] dark:bg-white/10 dark:text-[var(--sa-cream)]"}`}>Dashboard</button>
          <button onClick={() => setActiveTab("documents")} className={`rounded-md px-3 py-2 text-sm ${activeTab === "documents" ? "bg-[var(--sa-navy)] text-[var(--sa-cream)]" : "bg-[var(--sa-cream)]/60 text-[var(--sa-navy)] dark:bg-white/10 dark:text-[var(--sa-cream)]"}`}>Documents</button>
          <button onClick={() => setActiveTab("calculator")} className={`rounded-md px-3 py-2 text-sm ${activeTab === "calculator" ? "bg-[var(--sa-navy)] text-[var(--sa-cream)]" : "bg-[var(--sa-cream)]/60 text-[var(--sa-navy)] dark:bg-white/10 dark:text-[var(--sa-cream)]"}`}>Loss Calculator</button>
          <button onClick={() => setActiveTab("troubleshooter")} className={`rounded-md px-3 py-2 text-sm ${activeTab === "troubleshooter" ? "bg-[var(--sa-navy)] text-[var(--sa-cream)]" : "bg-[var(--sa-cream)]/60 text-[var(--sa-navy)] dark:bg-white/10 dark:text-[var(--sa-cream)]"}`}>Troubleshooter</button>
          <button onClick={() => setActiveTab("references")} className={`rounded-md px-3 py-2 text-sm ${activeTab === "references" ? "bg-[var(--sa-navy)] text-[var(--sa-cream)]" : "bg-[var(--sa-cream)]/60 text-[var(--sa-navy)] dark:bg-white/10 dark:text-[var(--sa-cream)]"}`}>References</button>
        </div>
          ...
          <>
            <section className="rounded-xl border border-black/5 bg-white p-6 shadow-sm dark:border-white/15 dark:bg-black/40">
              ...
              <div className="mt-4 flex gap-2">
                <button onClick={() => setUserStatus("enlisted")} className={`rounded-md px-3 py-2 text-sm font-semibold ${userStatus === "enlisted" ? "bg-[var(--sa-navy)] text-[var(--sa-cream)]" : "bg-[var(--sa-cream)]/60 text-[var(--sa-navy)] dark:bg-white/10 dark:text-[var(--sa-cream)]"}`}>Enlisted</button>
                <button onClick={() => setUserStatus("officer")} className={`rounded-md px-3 py-2 text-sm font-semibold ${userStatus === "officer" ? "bg-[var(--sa-navy)] text-[var(--sa-cream)]" : "bg-[var(--sa-cream)]/60 text-[var(--sa-navy)] dark:bg-white/10 dark:text-[var(--sa-cream)]"}`}>Officer</button>
              </div>
        ...
        {activeTab === "references" && (
          <section className="rounded-xl border border-black/5 bg-white p-6 shadow-sm dark:border-white/15 dark:bg-black/40">
            ...
            <div className="mt-6 rounded-2xl bg-[var(--sa-navy)] p-8 text-[var(--sa-cream)]">
              ...
              <a href="#" className="mt-4 inline-flex items-center gap-2 rounded-lg bg-[var(--sa-red)] px-6 py-3 text-white transition hover:bg-[#b91c1c]">
