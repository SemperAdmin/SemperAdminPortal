...
Per JTR Chapter 4, POV TDY travel is limited by daily mileage rules. The standard is 350 miles per day. Travel over 350 miles per day requires AO authorization. Per MCO 1000.6<Citation source="MCO 1000.6" /> Chapter 4 Section 3, proceed time is a separate four-day allowance, not chargeable to leave, and it attaches to PCS moves rather than TDY. Proceed does not authorize for TDY, accession, separation, retirement, release from active duty, or a CONUS move between stations in close proximity.
