...
Per DoD 7000.14-R Volume 7A<Citation source="DoD 7000.14-R Volume 7A" /> Chapter 1 paragraph 2.1.1, the Pay Entry Base Date (PEBD) is the date that denotes how much creditable service a member has for the purpose of determining longevity pay rates. The Marine Corps refers to this as "pay entry base date." Marine Corps computation procedures sit under PAA 04-25<Citation source="PAA 04-25" />, which standardizes PEBD computation across the force.
