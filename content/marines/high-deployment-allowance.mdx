...
Support of operations and exercises. Logistics, communications, and engineering support deployed behind a primary deploying force.

### Home Station Training or Local Operating Area

Per MARADMIN 436/26<Citation source="MARADMIN 436/26" />, home station training and the local operating area of a ship or vessel count as deployment-type events.

### Hospitalization Away from the PDS

Per MARADMIN 436/26<Citation source="MARADMIN 436/26" />, hospitalization not at or near your permanent duty station or homeport counts as a deployment-type event. Hospitalization near your PDS is a non-deployment event.

## Non-Deployment PERSTEMPO Events

Per MARADMIN 436/26<Citation source="MARADMIN 436/26" />, a second set of events is tracked and does NOT count toward the PERSTEMPO threshold. Individual training, duty in garrison, hospitalization near your PDS or homeport, disciplinary events, Reserve Component inactive duty training, muster duty, and funeral honors duty.

Tracking is not the same as counting. A non-deployment event appears in your PERSTEMPO record and adds nothing to the threshold sum.

## HDA and the PERSTEMPO Threshold Are Different Numbers

Two thresholds sit close enough to get confused. They are separate systems with separate consequences.

| | HDA | PERSTEMPO waiver |
| --- | --- | --- |
| Authority | DoD 7000.14-R Vol 7A Chapter 65 | MARADMIN 436/26 and 10 U.S.C. 991 |
| Threshold | 401 days deployed in the preceding 730, or 191 consecutive | 400 deployment days away in the preceding 730 |
| What happens | You are paid an allowance | Your command requests a waiver from DC M&RA |

Crossing one does not automatically mean crossing the other. The day-counting rules differ, and HDA carries a second qualifying path on consecutive days PERSTEMPO does not use. PERSTEMPO and Your Deployment Record at /marines/perstempo-and-your-deployment-record covers the day away counting rule driving the PERSTEMPO side.
