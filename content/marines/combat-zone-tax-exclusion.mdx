...
The senior enlisted basic pay rate updates each year. The HFP/IDP half is set by MARADMIN 433/26<Citation source="MARADMIN 433/26" />, effective 1 October 2026.

### The HFP/IDP Half of the Cap

Which pay you draw changes your cap, since the two amounts differ.

- Officer drawing HFP adds $450.
- Officer drawing IDP adds up to $275, prorated daily.

### Maximum CZTE for Officers

The maximum CZTE for officers updates as the senior enlisted basic pay rate updates. Work the cap in two steps. Take the current senior enlisted basic pay rate (E-9 over 38), then add the HFP or IDP amount for the month from the list above.
