...
- The Savings Deposit Program you qualify for while drawing the exclusion

<Callout variant="tip" title="Drawing CZTE opens a 10 percent savings account">
Marines drawing the Combat Zone Tax Exclusion qualify for the
[Savings Deposit Program](/marines/savings-deposit-program) after 30 consecutive
days in an eligible area. It pays 10 percent a year, compounded quarterly, on up
to 10,000 dollars, and the money returns to you automatically 120 days after you
...
- An E-7 with $4,500 basic pay, $300 FSA, a full month of IDP, and a $50,000 SRB lump sum during a month in Iraq. ALL of it is non-taxable for federal purposes.
- A Warrant Officer with $5,500 basic pay, a full month of IDP, and $750 SDAP during a deployment month. ALL of it is non-taxable.
...
Both halves of the cap move. The senior enlisted basic pay rate updates each year. The HFP/IDP half changed on 01 October 2026 under MARADMIN 433/26<Citation source="MARADMIN 433/26" />.

### The HFP/IDP Half of the Cap

Which pay you draw now changes your cap, since the two amounts no longer match.

| Month of service | Officer drawing HFP adds | Officer drawing IDP adds |
| --- | --- | --- |
| Through 30 Sep 2026 | $225 | Up to $225, prorated daily |
| From 01 Oct 2026 | $450 | Up to $275, prorated daily |

An officer drawing full HFP in October 2026 carries a cap $225 higher than the same officer in September 2026.

### Maximum CZTE for Officers

The maximum CZTE for officers updates as the senior enlisted basic pay rate updates. Work the cap in two steps. Take the current senior enlisted basic pay rate (E-9 over 38), then add the HFP or IDP amount for the month from the table above.

Verify the current senior enlisted basic pay rate against the active pay table and the current CZTE officer cap in IRS Publication 3 (Armed Forces Tax Guide) at https://www.irs.gov/publications/p3.

### Officer Pay Above the Cap is Taxable

Compensation above the cap remains taxable. A Captain (O-3) with $7,000 monthly basic pay deployed to a CZ has all $7,000 excluded, since it sits below the cap. A Colonel (O-6) with $12,000 monthly basic pay has only the cap amount excluded. The remainder stays taxable.
