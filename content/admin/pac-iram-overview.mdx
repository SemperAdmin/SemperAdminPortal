...
## When MARADMINs Update the IRAM

The IRAM is a controlling document but MARADMINs supersede or supplement it.

- MARADMIN 015/20<Citation source="MARADMIN 015/20" /> updated OMPF submission requirements
- MARADMIN 604/24<Citation source="MARADMIN 604/24" /> directed UD/MIPS document storage
- Other MARADMINs may modify specific chapters

PAC must track active MARADMINs and apply current guidance over older IRAM provisions.
