...
Per 10 USC 12301<Citation source="10 USC 12301" />(b) and MCRAMM Chapter 7, Annual Training (AT) is the SELRES (Selected Reserve, what most Marines call SMCR or the Reserves) member's primary active duty period each year. Per MCRAMM Chapter 3 Section 3, AT is a subset of Active Duty for Training (ADT).
