...
4. Build the authorization. The traveler or NDEA builds the authorization in DTS line by line, covering travel dates, mode of travel, lodging, and per diem.
...
- Lodging type. Government quarters versus commercial lodging per JTR Chapter 2 and Chapter 9 rules. The unit travel posture drives the call.
