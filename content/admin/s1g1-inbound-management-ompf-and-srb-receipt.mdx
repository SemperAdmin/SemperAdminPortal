...
summary: "Receive the OMPF Field Folder from the losing unit at inbound check-in per MCO P1070.12K Chapter 2, audit the SRB content, and reconstruct missing documents per the IRAM framework."
roles: ["admin", "leader"]
...
source:
  title: "OMPF and SRB Receipt - MCO P1070.12K Chapter 2"
...
8. Cut a Page 11. Per MCO P1070.12K paragraph 4006, the Page 11 documents the receipt and any reconstruction.
