...
references:
  ...
  - "PAA 04-21 - Payment of Deployed Per Diem for Reserve Activations, Mobilizations, and Individual Augments"
  - "PAA 02-15 - Standard Flat Rate Per Diem Allowance for Georgia Deployment Program ISAF"
relatedRoles:
...
4. **Member exceeds annual cap.** IDT travel reimbursement might have annual cap. Verify before processing.
