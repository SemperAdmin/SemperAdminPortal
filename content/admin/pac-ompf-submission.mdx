...
performanceSteps:
  ...
  - "Upload via approved system per MARADMIN 604/24"
...
### Step 4 - Upload Per MARADMIN 604/24

Process through UD/MIPS document storage.

- Scan document if hard copy (300 DPI minimum)
- Apply metadata in upload interface
- Submit upload
