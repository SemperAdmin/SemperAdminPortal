...
- Pay excluded up to a monthly cap (highest enlisted basic pay rate plus the HFP or IDP the officer draws)
...
5. **Officer cap computed at the retired HFP/IDP amount.** MARADMIN 433/26 raised HFP to $450 and the IDP ceiling to $275 on 01 October 2026. Both pays ran at $225 before that date. The cap moves with whichever pay the officer draws, so an October 2026 cap built on $225 understates the exclusion.
