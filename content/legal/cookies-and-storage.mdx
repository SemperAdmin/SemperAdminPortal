...
### Terms Acknowledgment Record

**Key:** `semper-admin-terms-accepted`  
**Type:** localStorage (persists across browser sessions)  
**Purpose:** Records the date you acknowledged the disclaimer and terms, and the version of the terms shown to you  
**Data:** JSON object, for example `{"version":"2026-09-11","acceptedAt":"2026-09-11T14:02:11.418Z"}`  
**Retention:** Persists indefinitely until you clear browser data.  
**Size:** Bytes.  
**Effect:** If the stored version matches the current terms version, the acknowledgment dialog stays hidden. When the terms are revised the version changes, the stored record no longer matches, and the dialog returns once against the new text.
