...
## Partially superseded by PAA 02-26

PAA 02-26 replaced the AutoSAAR submission path described below. Effective
21 September 2026, DoD E-ICAM is the authoritative method to request, modify, and
revoke MCTFS end-user access. Commands stopped submitting through AutoSAAR,
legacy email, and locally routed DD Form 2875 processes after 17 September 2026.

The rest of this policy stands. TASO creation and deletion of the User ACID, the
30-day auto-suspend and 45-day auto-delete rule, levels of privilege, MOS-to-role
mapping, and the MOL and UDMIPS sections are untouched. Read every AutoSAAR
reference below as historical.

## Scope

This policy governs access to the Marine Corps Total Force System Family of Services (MCTFS FoS), which holds Marine Corps pay and personnel data on the mainframe plus the Marine-On-Line (MOL) services layered on top. It supersedes prior editions and sets the standard approval process, submission path, levels of privilege, account management, MOS-to-role mapping, annual recertification, and de-provisioning. Addendum 9 is dated 15 April 2026 and takes effect immediately.
...
- Manpower MCTFS access. Historical path, retired 17 September 2026. Submitted through AutoSAAR at https://autosaar.usmc.mil, routing user, supervisor, security manager, then MISSA, which validated and submitted a JIRA request to TSO for provisioning. Current path is DoD E-ICAM per PAA 02-26.
...
Active and gated, with the AutoSAAR submission path superseded by PAA 02-26. The source sits behind DoD authentication on the MISSA SharePoint. Reach the SAAR landing page and the policy PDF at the external link above. The MISSA point of contact is listed in the addendum. Confirm the current addendum before relying on a specific paragraph.
