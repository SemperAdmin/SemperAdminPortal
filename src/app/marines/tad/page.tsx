    ...
    <div className="mx-auto max-w-6xl">
      ...
      <section className="mt-10 rounded-[var(--radius-md)] border border-[var(--color-border)] bg-[var(--color-muted)]/40 p-5">
        ...
        <p className="mt-2 text-sm">
          TDY/TAD content sources from the DoD Joint Travel Regulations (JTR)
          Chapters 2-4 (Travel Authorization, TDY Travel and Allowances), DoDI
          5154.31 Volume 5 (Defense Travel System), the Government Travel Charge
          Card Program directives, and current MARADMINs governing TDY
          allowances and DTS procedures.
        </p>
        <p className="mt-3 text-sm">
          Each topic page cites the controlling JTR chapter, paragraph, and DTMO
          rate table reference. Verify current per diem rates through DTMO before
          action.
        </p>
      </section>
    </div>
