...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-[var(--color-background)] text-[var(--color-foreground)] shadow-[var(--shadow-card-strong)] transition ease-in-out data-[state=closed]:duration-200 data-[state=open]:duration-300 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
