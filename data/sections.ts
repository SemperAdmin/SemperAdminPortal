  ...
  "marine-online": {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          { title: "Annual Retirement Credit Report (ARCR)", slug: "mol-arcr", desc: "View retirement credit points for reserve Marines" },
          { title: "Aviation Career Incentive Pay (ACIP)", slug: "mol-acip", desc: "View flight pay eligibility and aviation bonus status" },
          { title: "Awards", slug: "mol-awards", desc: "View decorations, medals, and unit awards" },
          { title: "Basic Individual Record (BIR)", slug: "mol-bir", desc: "View comprehensive personnel snapshot including service data" },
          { title: "Basic Training Record (BTR)", slug: "mol-btr", desc: "View training history and qualifications" },
          { title: "BRS/TSP Information", slug: "mol-brs-tsp", desc: "View Blended Retirement System and Thrift Savings Plan info" },
          ...
          { title: "Pers-Tempo", slug: "mol-pers-tempo", desc: "View personnel tempo and deployment tracking" },
          { title: "Personal Statement of Military Compensation (PSMC)", slug: "mol-psmc", desc: "View total compensation breakdown" },
          { title: "Reserve Drill Summary", slug: "mol-reserve-drill", desc: "View drill attendance for reservists" },
          { title: "Record of Service (ROS)", slug: "mol-ros", desc: "View complete service record" },
          { title: "W2 Tax Statements", slug: "mol-w2", desc: "View and download annual tax documents" },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          { title: "RED Overview", slug: "mol-red", desc: "View and update emergency contacts and beneficiaries" },
          { title: "RED Certification", slug: "mol-red-certification", desc: "Certify Record of Emergency Data accuracy" },
          { title: "RED Family Information", slug: "mol-red-family", desc: "Update spouse and dependent information" },
          { title: "RED Parents Information", slug: "mol-red-parents", desc: "Update parent contact and beneficiary details" },
          { title: "RED Next of Kin (NOK)", slug: "mol-red-nok", desc: "Designate emergency notification contacts" },
          { title: "RED Insurance Information", slug: "mol-red-insurance", desc: "View and update SGLI and other insurance beneficiaries" },
          { title: "RED Death Gratuity", slug: "mol-red-death-gratuity", desc: "Designate death gratuity beneficiaries" },
          { title: "RED Person Authorized to Direct Disposition (PADD)", slug: "mol-red-padd", desc: "Designate person authorized for remains disposition" },
          { title: "RED Pay Arrears (Unpaid Pay/Allowances)", slug: "mol-red-pay-arrears", desc: "Designate beneficiary for unpaid pay and allowances" },
          { title: "RED Do Not Notify", slug: "mol-red-do-not-notify", desc: "Specify persons NOT to be notified in case of emergency" },
          { title: "RED MIA (Missing in Action) Notification", slug: "mol-red-mia", desc: "Designate MIA notification preferences" },
        ],
      },
      {
        title: "Administrative Actions",
