  ...
  "marine-online": {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          { title: "Awards Module", slug: "mol-awards-module", desc: "Recommend/approve MCGCM and SMCRM, generate certificates, report to MCTFS" },
          { title: "Basic Orders System (BOS)", slug: "mol-basic-orders-system", desc: "View PCA and PCS Basic Orders for members and unit leaders" },
          { title: "BIC Assignment", slug: "mol-bic-assignment", desc: "Manage Billet Identification Code assignments for AD and FAP personnel" },
          { title: "Commanders Messaging", slug: "mol-commanders-messaging", desc: "Disseminate messages to subordinate unit personnel on MOL home page" },
          { title: "EPAR (Electronic Personnel Administrative Request)", slug: "mol-epar", desc: "Submit and route administrative requests through the chain of command" },
          { title: "Family Care Plan", slug: "mol-family-care-plan", desc: "Manage caregiver designations for dependents with dashboard tracking" },
          { title: "Family Readiness", slug: "mol-family-readiness", desc: "Manage contact information and correspondence for unit FRO program" },
          { title: "Inbound Interview (IBI)", slug: "mol-inbound-interview", desc: "Onboard incoming personnel with join, BIC, and Co/Plt/WS assignment" },
          { title: "JEPES Module", slug: "mol-jepes-module", desc: "Evaluate Pvt-Cpl Marines with Command Input Marks for promotion/retention" },
          { title: "Travel Voucher (TVI/FTV)", slug: "mol-travel-voucher", desc: "Submit travel claims directly to disbursing for separation settlement" },
          { title: "Leave/Liberty Module", slug: "mol-leave-liberty-module", desc: "Route absence requests with UMSR updates and SLA restoration" },
          { title: "Official Military Personnel File (OMPF)", slug: "mol-ompf-module", desc: "View electronic OMPF, Master Brief Sheets, and RS/RO Profiles" },
          { title: "Organization Management", slug: "mol-organization-management", desc: "Manage organizations and hierarchical associations for MOL services" },
          { title: "Outbound Interview", slug: "mol-outbound-interview", desc: "Input PCA/PCS/SEPS travel plans for entitlements and advances" },
          { title: "Permissions Management", slug: "mol-permissions-management", desc: "Manage application roles and permissions within organizational scope" },
          { title: "Personal Information (PI)", slug: "mol-personal-information", desc: "View personnel records and submit self-certified transactions to MCTFS" },
          { title: "Personnel Accountability", slug: "mol-personnel-accountability", desc: "Self-report accountability status for members and families to DoD PARS" },
          { title: "Promotion Recs", slug: "mol-promotion-recs", desc: "Make monthly/quarterly promotion recommendations for Pvt-Cpl Marines" },
          { title: "Trouble Ticket System (TTS)", slug: "mol-trouble-ticket-system", desc: "Submit system issues to your jurisdictional MISSO" },
          { title: "Unit Management Status Report (UMSR)", slug: "mol-umsr", desc: "Execute daily muster including gains/losses and duty status changes" },
          { title: "Unit Reports (Cognos)", slug: "mol-unit-reports-cognos", desc: "Ad hoc and canned reporting on pay, personnel, and application data" },
          { title: "User Management", slug: "mol-user-management", desc: "Manage user accounts and Non-Marine records within organizational scope" },
