    ...
    <div className="space-y-6">
      ...
      <section className="rounded-2xl bg-[var(--sa-cream)] px-6 py-8 shadow-sm ring-1 ring-black/5 dark:bg-[var(--sa-navy)]">
        ...
        <div className="mt-6 flex flex-wrap gap-4">
          <a href="https://teams.microsoft.com/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center rounded-full bg-[var(--sa-navy)] px-6 py-3 text-[var(--sa-cream)] shadow-sm transition hover:bg-[var(--sa-navy-hover)]">Open Teams Channel</a>
