        ...
        <div className="lg:col-span-2 space-y-6">
          {activeTab === "overview" && (
            <section className="rounded-xl border border-black/5 bg-white p-6 shadow-sm dark:border-white/15 dark:bg-black/40">
              <h2 className="text-xl font-semibold text-[var(--sa-navy)] dark:text-[var(--sa-cream)]">Marriage Documentation Overview</h2>
              <p className="mt-2 text-sm text-zinc-700 dark:text-zinc-300">
                Comprehensive guide for adding a spouse as a dependent. Learn about required documentation,
                NAVMC 10922 procedures, and DEERS enrollment for newly married service members.
              </p>
          ...
          {activeTab === "requirements" && (
            <section className="rounded-xl border border-black/5 bg-white p-6 shadow-sm dark:border-white/15 dark:bg-black/40">
              ...
              <p className="mt-2 text-sm text-zinc-700 dark:text-zinc-300">
                Required documents and verification procedures for marriage documentation.
              </p>
            </section>
          )}
          ...
          {activeTab === "process" && (
            <section className="rounded-xl border border-black/5 bg-white p-6 shadow-sm dark:border-white/15 dark:bg-black/40">
              ...
              <p className="mt-2 text-sm text-zinc-700 dark:text-zinc-300">
                Step-by-step process for enrolling a spouse in DEERS and updating records.
              </p>
            </section>
          )}
          ...
          {activeTab === "forms" && (
            <section className="rounded-xl border border-black/5 bg-white p-6 shadow-sm dark:border-white/15 dark:bg-black/40">
              ...
              <p className="mt-2 text-sm text-zinc-700 dark:text-zinc-300">
                NAVMC 10922 and other required forms for marriage documentation.
              </p>
            </section>
          )}
