...
import { SAFETY_CLIMATE_SURVEY_DATA } from "../../../data/transitionCommandData";
import {
  ClipboardList,
  CheckCircle,
  FileText,
...
export function SafetyClimateSurveyContent() {
  const data = SAFETY_CLIMATE_SURVEY_DATA;
    ...
    <div className="space-y-6">
      ...
      <section className="rounded-xl border border-black/5 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-black/40">
        ...
        <div className="grid gap-2 text-sm sm:grid-cols-2">
          <div><span className="font-medium">Name:</span> {data.surveyInfo.name}</div>
          <div><span className="font-medium">Managed By:</span> {data.surveyInfo.managedBy}</div>
          <div><span className="font-medium">Who Takes:</span> {data.surveyInfo.whoTakes}</div>
      ...
      <section className="rounded-xl border border-black/5 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-black/40">
        ...
        <ul className="space-y-2">
          {data.documentationRequirements.map((req, idx) => (
