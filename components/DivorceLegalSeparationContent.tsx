        ...
        <div className="lg:col-span-2 space-y-6">
          {activeTab === "overview" && (
            <section className="rounded-xl border border-black/5 bg-white p-6 shadow-sm dark:border-white/15 dark:bg-black/40">
              ...
              <p className="mt-2 text-sm text-zinc-700 dark:text-zinc-300">
                Comprehensive guide for removing a former spouse from dependent records following divorce or legal separation.
                Learn about required documentation, DEERS updates, and benefits termination timelines.
              </p>
          ...
          {activeTab === "requirements" && (
            <section className="rounded-xl border border-black/5 bg-white p-6 shadow-sm dark:border-white/15 dark:bg-black/40">
              ...
              <p className="mt-2 text-sm text-zinc-700 dark:text-zinc-300">
                Required documents for divorce/legal separation processing including court decrees and separation agreements.
              </p>
            </section>
          )}
          ...
          {activeTab === "process" && (
            <section className="rounded-xl border border-black/5 bg-white p-6 shadow-sm dark:border-white/15 dark:bg-black/40">
              <h2 className="text-xl font-semibold text-[var(--sa-navy)] dark:text-[var(--sa-cream)]">Removal Process</h2>
              <p className="mt-2 text-sm text-zinc-700 dark:text-zinc-300">
                Step-by-step process for removing a former spouse from DEERS and updating records.
              </p>
            </section>
          )}
          ...
          {activeTab === "benefits" && (
            <section className="rounded-xl border border-black/5 bg-white p-6 shadow-sm dark:border-white/15 dark:bg-black/40">
              ...
              <p className="mt-2 text-sm text-zinc-700 dark:text-zinc-300">
                How divorce affects BAH, TRICARE, and other benefits. Transitional benefits and 20/20/20 rule information.
              </p>
            </section>
          )}
