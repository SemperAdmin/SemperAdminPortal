...
# MARINES (General - All Roles)

These affect ALL users and should be highest priority.
...
| Slug | Title | Description |
|------|-------|-------------|
| `deocs-requirements` | DEOCS Requirements | Timeline, administration, and using survey results |
...
| `pac-program-overview` | PAC Program Overview | Discrimination, harassment, hazing, and retaliation prevention |
| `pac-policy-statement` | PAC Policy (90 Days) | Prohibited Activities and Conduct policy statement |
...
| `upfrp-sop-requirement` | UPFRP SOP (60 Days) | Unit Personal and Family Readiness Program SOP |
...
| Slug | Title | Description |
|------|-------|-------------|
| `personnel-security` | Personnel Security | Clearance sponsorship and access determination |
| `infosec-program` | Information Security Program | Classified information handling and protection |
| `classified-accountability` | Classified Material Accountability | Inventory and control procedures |
| `physical-security` | Physical Security | Facility and asset protection |
| `opsec-program` | OPSEC Program | Operations Security planning and implementation |
| `cybersecurity-program` | Cybersecurity Program | Network security and cyber hygiene |
| `atfp-program` | AT/FP Program | Antiterrorism and Force Protection |
| `insider-threat` | Insider Threat Program | Identifying and mitigating insider threats |
...
No placeholder items - all admin content has been built.

---

# Content Template

When providing content for any item, include:
...
- Within X days: Action required
- Within Y days: Next action

REFERENCES:
- MCO XXXX.XX - Order title
- NAVMC XXXX - Form or publication
...
1. **Marines (General) items** - Highest priority. These are accessed by all users.
